...
export default function GuardianSchoolDayPage() {
  const [workspace, setWorkspace] = useState(previewWorkspace);
  const [actor, setActor] = useState("Efua Agyeman");
    ...
    <main className="school-day-shell guardian-day-shell">
      ...
      <div className="school-day-page" id="family-day">
        <section className="guardian-day-welcome">
          <div>
            <p>Family updates · {formatLongDate(workspace.currentDate)}</p>
            <h1>Know what happened at school today.</h1>
            <span>
              Attendance alerts come only from submitted school registers.
              Due work and timetable changes use the same protected child
              record.
            </span>
          </div>
